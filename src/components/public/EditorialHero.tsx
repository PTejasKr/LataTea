  ...
  return (
    <section className="relative h-[90vh] md:h-screen flex items-center justify-center overflow-hidden bg-brand-primary-dark text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 text-center flex flex-col items-center animate-fade-in-up">
        ...
        <h1 className="font-rajwada text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight text-white leading-[1.1] drop-shadow-lg mb-6">
          {t(hero.headline)}
        </h1>

        <p className="mt-4 text-sm sm:text-base md:text-lg text-slate-200 max-w-2xl font-sans font-medium leading-relaxed drop-shadow-md">
          {t(hero.subheadline)}
        </p>
