  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-5xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 p-6 sm:p-8 rounded-3xl bg-[#1E293B] border border-slate-700/80 shadow-lg space-y-4 text-cms-small">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-cms-small text-slate-400 font-mono">{currentTitle.length} / 60 chars</span>
            </div>
            <input
              type="text"
              value={currentTitle}
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-cms-small text-slate-400 font-mono">{currentDesc.length} / 160 chars</span>
            </div>
            <textarea
              rows={3}
              value={currentDesc}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 rounded-xl border border-slate-700 bg-slate-900 text-white font-mono text-cms-small"
              />
            </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 rounded-3xl bg-[#1E293B] border border-slate-700/80 shadow-lg space-y-3">
            <span className="text-cms-small font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
            ...
            <div className="p-4 rounded-2xl bg-white text-slate-900 shadow-sm space-y-1.5 font-sans">
              <div className="text-cms-small text-slate-500 truncate flex items-center gap-1 font-mono">
              ...
              <div className="text-cms-small text-slate-600 line-clamp-2 leading-relaxed">
