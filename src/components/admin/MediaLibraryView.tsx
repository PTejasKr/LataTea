...
export const MediaLibraryView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-150">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#222]">
        ...
        <div>
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-sm bg-white text-black font-bold uppercase tracking-wider text-cms-small flex items-center gap-1.5  disabled:opacity-50"
          >
      ...
      {/* Search Bar */}
      <div className="flex items-center gap-3 p-3 rounded-sm bg-[#0a0a0a] border border-[#222]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            {filteredMedia.map(media => {
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-sm border transition-all cursor-pointer group flex flex-col justify-between ${
                    isSelected
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between text-cms-small text-neutral-400 mt-1">
                      <span>{media.fileSize || 'Asset'}</span>
                      <span className="uppercase text-white/80">{media.mediaType?.split('/')[1] || 'img'}</span>
                    </div>
                  </div>
                </div>
              );
        ...
        {selectedMedia && (
          <div className="lg:col-span-4 p-6 rounded-3xl bg-[#0a0a0a] border border-[#222]  space-y-4 text-cms-small">
            ...
            <div className="aspect-video w-full rounded-sm overflow-hidden bg-slate-950 flex items-center justify-center p-2">
              <img src={selectedMedia.url} alt={selectedMedia.alt} className="max-h-full max-w-full object-contain" />
            </div>

            <div className="space-y-3">
              <div>
                <label className="block text-neutral-400 font-bold uppercase text-cms-small mb-1">
                  Filename
                </label>
                <div className="font-mono text-white break-all bg-[#0a0a0a] p-2 rounded-sm border border-slate-800">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-sm bg-[#0a0a0a] border border-[#222] text-white font-sans text-cms-small"
                />
              </div>

              <div className="grid grid-cols-2 gap-2 text-cms-small text-neutral-400 bg-[#0a0a0a] p-3 rounded-sm border border-slate-800">
                <div>
                  <span className="block text-neutral-500">File Size:</span>
                  <span className="text-white font-bold">{selectedMedia.fileSize || 'N/A'}</span>
                </div>
                <div>
                  <span className="block text-neutral-500">MIME Type:</span>
              ...
              <div className="pt-2 flex items-center justify-between">
                <button
                  ...
                  className="px-3 py-1.5 rounded-sm bg-neutral-800 text-white/20 text-white border border-[#333] hover:bg-neutral-800 text-white/30 transition-colors flex items-center gap-1.5"
                >
