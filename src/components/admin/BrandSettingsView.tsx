...
import { Palette, Sparkles, RefreshCw, Check } from 'lucide-react';
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-[#1E293B] border border-slate-700/80 shadow-lg space-y-5">
          ...
          <div className="space-y-4 text-cms-small">
            ...
            <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-2">
              ...
              <div className="h-20 w-full rounded-xl bg-latagreen-800 flex items-center justify-center p-2">
                {logoPrimary.url ? (
            ...
            <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-2">
              ...
              <div className="h-20 w-full rounded-xl bg-slate-950 flex items-center justify-center p-2">
                {logoLight.url ? (
